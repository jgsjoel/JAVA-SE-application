...
public class AddNewCategory extends javax.swing.JDialog {
    ...
    public void loadCategories() {
        try {
            ...
            ResultSet rs = Mysql.search("SELECT * FROM `category` " + query + "");
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Categories", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (category.isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "This category already exist", "Warning", JOptionPane.WARNING_MESSAGE);
                } else {
                    Mysql.iud("INSERT INTO `category`(`name`) VALUES('" + category + "')");
                    JOptionPane.showMessageDialog(this, "category has been added", "Success", JOptionPane.INFORMATION_MESSAGE);
                    clearFields();
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (i == JOptionPane.YES_OPTION) {
                ...
                String category_name = jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString();

                category_id = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
        ...
        if (category.isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    Mysql.iud("UPDATE `category` SET `name`='" + category + "' WHERE `id`='" + category_id + "' ");
